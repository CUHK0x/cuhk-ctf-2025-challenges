...
Some challenges work with a challenge remote server. You can deploy one with the files inside the `deploy` folder in the challenge. However, please note that you shouldn't expose the challenges to the public or your machine might be compromised. It is highly recommended to do it in a virtual machine.
